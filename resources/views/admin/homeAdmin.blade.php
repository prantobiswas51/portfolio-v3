...
@section('content')
    <div class="">
        ...
        <section class="mb-32 flex flex-col md:flex-row">

            <div class="basis-1/4 border h-screen text-white p-4 flex flex-col ">
                <ul class="pb-2 space-y-2 text-white">
                    ...
                    <li>
                        ...
                        <ul id="40038942" class="hidden py-2 space-y-2">
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/posts">View all Posts</a>
                            </li>
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/posts/create">Add new Posts</a>
                            </li>
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/posts/categories/manage">Categories</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <button type="button"
                            class="w-full flex items-center p-2 text-base text-gray-600 rounded-lg hover:bg-gray-100 group dark:text-gray-300 dark:hover:bg-gray-700 border dark:border-gray-700"
                            aria-controls="267609225" data-collapse-toggle="267609225">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <ul id="267609225" class="hidden py-2 space-y-2">
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/products">View all Products</a>
                            </li>
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/products/create">Add new Product</a>
                            </li>
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/products/categories/manage">Categories</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <button type="button"
                            class="w-full flex items-center p-2 text-base text-gray-600 rounded-lg hover:bg-gray-100 group dark:text-gray-300 dark:hover:bg-gray-700 border dark:border-gray-700"
                            aria-controls="539897591" data-collapse-toggle="539897591">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <ul id="539897591" class="hidden py-2 space-y-2">
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/orders">View all Orders</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button"
                            class="w-full flex items-center p-2 text-base text-gray-600 rounded-lg hover:bg-gray-100 group dark:text-gray-300 dark:hover:bg-gray-700 border dark:border-gray-700"
                            aria-controls="106720949" data-collapse-toggle="106720949">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Bkash</span>
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5">
                                </path>
                        ...
                        <ul id="106720949" class="hidden py-2 space-y-2">
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/bkash/transactions">View all transaction</a>
                            </li>
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/bkash/searchTransaction">Search transaction</a>
                            </li>
                            <li>
                                <a class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 border border-dashed dark:border-gray-700"
                                    href="https://itsourov.com/admin/bkash/refund-status">Refund Status</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a class="w-full flex items-center p-2 text-base text-gray-600 rounded-lg hover:bg-gray-100 group dark:text-gray-300 dark:hover:bg-gray-700 border dark:border-gray-700"
                            href="https://itsourov.com/admin/users/users">
            ...
            <div class="basis-3/4 border p-4 md:p-16">
