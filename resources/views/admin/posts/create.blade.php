...
<div class="w-full min-h-screen bg-gray-900/50 backdrop-blur hidden justify-center items-center fixed z-50"
    ...
    <div class="sub-container p-4 max-w-[700px]">
        ...
        <div id="popCross" class="flex justify-end hover:cursor-pointer">
        ...
        <div class="">
            <button id="savePostImage" class="p-2 border rounded-md px-4 text-white bg-green-800">Save</button>
        </div>
    </div>
</div>
...
<x-admin-layout>
            ...
            <div class="space-y-4">
                ...
                <div class="pr-2 w-full mb-6">
                    ...
                    <div id="featured_div"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            fill="#000000" version="1.1" id="Capa_1" width="50px" height="50px"
                ...
                <div class="pr-2 w-full">
                    ...
                    <select id="countries" name="status"
                        ...
                        <option value="draft" class="p-2">Draft</option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $('#savePostImage').on('click', function(ev) {
            ...
            resize.croppie('result', {
                ...
                if (img != null) {
                    document.getElementById('imgSaver').value = img
                    document.getElementById('featured_div').innerHTML = "Image Picked"
