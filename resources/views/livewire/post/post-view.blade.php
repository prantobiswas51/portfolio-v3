    ...
    <div class="my-2">
        <form action="" method="get" class="flex justify-between">
            ...
            <input type="submit" value="Search"
                class="bg-gray-800 hover:cursor-pointer rounded-r-[50px] text-black dark:text-white p-2">
        </form>
    </div>

    <div class="flex my-2">
        <div class="">
            <button class="border rounded-md p-2 mr-2 hover:bg-sky-900">Add New Post</button>
        </div>
        <div class="">
            <button class="border rounded-md p-2 mr-2 hover:bg-blue-900">Select</button>
        </div>
