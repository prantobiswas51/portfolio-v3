        ...
        <section class="grid grid-cols-1 md:grid-cols-2">
            <div class="flex flex-col justify-between p-8">
                ...
                <div class="grow-0 shrink-0 basis-auto md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
                    ...
                    <p class=" mb-2">+8801823744169</p>
                    <p class=" mb-2">prantobd320@gmail.com</p>
                ...
                <div class="grow-0 bg-gray-200 p-4 rounded-lg shrink-0  mb-12 md:mb-0 md:w-6/12 px-16 lg:px-6">
                    <form class="text-gray-900">
                        ...
                        <div class="form-group mb-6">
                            <p class="text-4xl text-gray-900 text-bold">Contact Form</p>
                        </div>
                        ...
                        <button type="submit"
                            class="w-full px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Send</button>
                    </form>
                </div>
            </div>
        </section>
