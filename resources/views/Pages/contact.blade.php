    ...
    <div class="container mx-auto">
      <div class="-mx-4 flex flex-wrap lg:justify-between">
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="relative rounded-lg bg-gray-100 dark:bg-gray-800 p-8 shadow-lg sm:p-12">
            ...
            <form>
              ...
              <div>
                <button type="submit" class="bg-primary border-primary w-full rounded border dark:text-black bg-gray-200 p-3 transition ">
                  Send Message
                </button>
              </div>
            </form>
