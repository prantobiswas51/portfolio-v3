<x-app-layout>
    ...
    <div class="searchblog p-2 m-6 ">
        <form action="" method="get" class="flex justify-between">
            ...
            <input type="submit" class="border text-black dark:text-white p-2">
        </form>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-2 py-24 px-6 mx-auto">
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            <a href="#">
                <img class="rounded-t-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-2.jpg"
                    alt="" />
            </a>
            <div class="p-5">
                <a href="#">
        ...
        <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow">
            <a href="#">
                <img class="rounded-t-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/square/image-1.jpg"
                    alt="" />
            </a>
            <div class="p-5">
                <a href="#">
